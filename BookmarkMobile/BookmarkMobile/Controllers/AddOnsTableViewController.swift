...
extension AddOnsTableViewController {
    ...
    override func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        let header = tableView.dequeueReusableHeaderFooterView(withIdentifier: "header") as? AddOnsTableViewHeader ?? AddOnsTableViewHeader(reuseIdentifier: "header")
...
extension AddOnsTableViewController: AddOnsTableViewHeaderDelegate {
