...
//        memorizationView.frame = G
        ...
        // View + Change button component...
        let myView = RoundView(frame: CGRect(x: 20, y: 100, width: 300, height: 80))
        myView.borderColor = UIColor.gray
        myView.backgroundColor = Styling.colorForCode(.themeLight)
        let viewLabel = UILabel(frame: CGRect(x: 70, y: 27, width: 200, height: 20))
        ...
        let priceLabel = UILabel(frame: CGRect(x: 45, y: 27, width: 30, height: 20))
        priceLabel.text = "5"
        priceLabel.font = Styling.font(weight: .regular, size: 25)
        priceLabel.textColor = Styling.colorForCode(.themeBlue)
        let changeButton = RoundButton(frame: CGRect(x: 220, y: 0, width: 80, height: myView.bounds.height))
        ...
        let touchableView = RoundView(frame: CGRect(x: 20, y: 200, width: 300, height: 60))
